...
public class FollowController {
	...
	public String focus(@PathVariable(value="userLogin")String userLogin,@RequestParam(value="page",defaultValue="1")Integer page,HttpSession session,ModelMap model){
		//登录用户
