...
import com.hzblogs.dao.PhotoAlbumsMapper;
import com.hzblogs.service.follow.FollowService;
import com.hzblogs.service.model.FollowModel;
import com.hzblogs.service.model.PhotoAlbumsModel;
import com.hzblogs.service.model.PhotoDetailModel;
import com.hzblogs.service.photoDetail.PhotoDetailService;
import com.hzblogs.tool.PageSupport;

/**
* @author zzke
* @version 创建时间：2021年7月21日 上午10:26:11
* @ClassName 
...
public class PhotoAlbumsServiceImpl implements PhotoAlbumsService{
	...
	public boolean selectPicAccessRight(Integer paId, Integer paUserid, Integer userid) {
		...
		//公开，返回true
		if(photoAlbumsModel.getPaJurisdiction().equals(1)){
			return true;
		}
		//博友，判断是否为博友/*相互关注*/是为true，反之
		if(photoAlbumsModel.getPaJurisdiction().equals(2)){
			/*这里先返回true，根据关注信息查询*/
		...
		//判断是否为本人
		if(photoAlbumsModel.getPaJurisdiction().equals(3) ){
